...
public class RegistroVacina {
	...
	// Ou, se for uma vacina de dose única, o construtor abaixo possibilita cadastrar um registro de vacina sem informar a dose:
	
	public RegistroVacina(LocalDate data, Lote lote, Cidadao cidadao, Funcionario vacinador, UnidadeSaude unidadeSaude) {
		setData(data);
		setLote(lote);
		setCidadao(cidadao);
		setVacinador(vacinador);
